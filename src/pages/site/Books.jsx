...
function Books() {
  return (
    <section>
      <Header />
      <section>
        <div style={{ backgroundImage: `url("${bookHeroSection}")` }} className="bookslanding bg-[#376489] grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 relative">
          <img
            src={bookslandimg2}
            className="block translate-y-20 w-full "
          />

          <div className="text-center gap-3 w-full block md:py-[100px]">
            <h2 className="text-[50px]  text-[#376489] font-extrabold font-montserrat">
              AMAZON BEST SELLER
            </h2>
            <p className="text-[50px] text-[#376489] font-normal font-mognolia">
              From Chaos To Connection
            </p>
            <p className="text-[17px] font-medium leading-[29px] font-montserrat text-[#274C69]">
          ...
          <img src={bookslandimg1} alt="" className=" mb-5 w-full " />
        </div>
        <div style={{ backgroundImage: `url("${ChaosBooks}")` }} className=" bg-left-bottom bg-no-repeat mt-20">
          <div className="flex items-center justify-end md:py-24 py-10 md:flex-nowrap flex-wrap-reverse relative">
        ...
        <div className="c_2 bg-[#F1E1E4]">
          <div className="container flex items-center justify-start md:py-28 md:pt-28 pt-5 md:flex-nowrap flex-wrap-reverse relative">
            <div className="md:w-[55%] w-[90%] mx-auto md:absolute z-50 bg-[#faf5f0c2] p-7 md:px-20 right-[3%] md:-translate-y-0 -translate-y-20">
              ...
              <div className="gap-2 grid grid-cols-2 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-4 ">
                <Link
                  to="https://mybook.to/FromChaostoConnection"
                  className="uppercase bg-[#376489] relative z-10 px-3 h-[50px] font-semibold rounded-full text-[#F1E1E4] mt-10 flex items-center gap-2"
                >
                ...
                <Link
                  to="https://mybook.to/FromChaostoConnection"
                  className="uppercase bg-[#376489] flex items-center gap-2 relative z-10 px-3 h-[50px] font-semibold rounded-full text-[#F1E1E4] mt-10"
                >
                  <img src={usa} alt="USA" />
                  USA
                </Link>
        ...
        <div style={{ backgroundImage: `url("${orderSignedFrom}")` }} className="bg-[#376489] bg-no-repeat bg-cover container booklastsec relative flex items-end py-24 my-40">
          <div className="w-[55%] ml-auto">
            ...
            <div className="gap-2 grid grid-cols-2 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-4 ">
              <Link
                to="https://mybook.to/FromChaostoConnection"
                className="uppercase bg-[#376489] relative px-3 text-[14px] h-[50px] font-semibold rounded-full text-[#F1E1E4] mt-10 flex items-center gap-2"
              >
                <img src={austriallia} alt="Australia" />
                Australia
              </Link>
              <Link
                to="https://mybook.to/FromChaostoConnection"
                className="uppercase bg-[#376489] flex items-center gap-2 relative px-3 text-[14px] h-[50px] font-semibold rounded-full text-[#F1E1E4] mt-10"
              >
                <img src={usa} alt="USA" />
                USA
              </Link>
