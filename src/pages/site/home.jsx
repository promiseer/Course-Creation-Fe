...
<div className="landing hidden md:flex bg-cover bg-center bg-no-repeat items-center justify-start" style={{ backgroundImage: `url(${stephhome})` }}>
  <div className="text-white cContainer text-center flex flex-col justify-center items-center gap-3 md:w-[60%] bg-opacity-70">
    ...
    <button className="uppercase bg-[#F1E1E4] font-semibold rounded-full w-[250px] h-[45px] text-[#274C69] mt-5">
      ...
      <div className="flex md:flex-row flex-col-reverse items-center justify-between cContainer py-20 md:gap-16 gap-10 sectionwithbg">
      ...
      <div className="cContainer text-center py-24">
          ...
          <div className="w-fit relative md:basis-[calc(100%/4-10px)]">
            ...
            <div className="bg-[#C2D5E4] w-[90%] mx-auto  -translate-y-[20%]  pt-5 pb-4 px-3">
              <div className="relative">
                ...
                <button className="uppercase bg-[#376489] font-semibold rounded-full w-[90%] h-[40px] text-[#F1E1E4] mt-5">
                  Listen Now
                </button>
              </div>
            </div>
      ...
      <div className="wecanHelp flex items-center py-16 justify-start">
        <div className="cContainer md:w-[68%]">
      ...
      {/* offereing  */}
      <div className="cContainer text-center py-20">
      ...
      {/* latest blog  */}
      <div className="py-20">
        <div className="cContainer w-full text-center">
          ...
          <div className="flex gap-5 justify-between md:flex-nowrap flex-wrap">
            <div className="blogs flex items-end py-4 px-6 text-center justify-center md:basis-[40%]">
              <div>
                ...
                <button className="uppercase bg-[#C1989F] mb-3 px-10 text-[16px] w-[250px] h-[40px] font-semibold rounded-full text-[#F1E1E4] mt-3">
                  Read more
                </button>
              </div>
            </div>
            <div className="flex flex-col gap-10 text-left md:basis-[55%]">
              <div className="flex items-center md:gap-5 gap-3">
                ...
                <div>
                  ...
                  <button className="uppercase bg-[#376489] px-10 text-base mx-auto  md:h-[40px] h-[36px] font-semibold rounded-full text-[#F1E1E4] mt-3">
                    Read more
                  </button>
                </div>
              </div>
          ...
          <button className="uppercase mt-20 bg-[#C1989F] px-10 text-[16px] !mx-auto w-[330px] h-[50px] font-semibold rounded-full text-[#F1E1E4]">
            All Blogs
          </button>
        </div>
      </div>
